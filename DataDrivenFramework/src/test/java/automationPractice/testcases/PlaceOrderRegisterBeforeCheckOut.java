...
public class PlaceOrderRegisterBeforeCheckOut extends TestcaseBase {
	...
	public void placeOrderRegisterBeforeCheckOut() {
		...
		sign.signUp("Shritik", "qbgdgy567u@gmail.com");
		sign.fillForm("mr", "Swati@123", "4", "5", "2000");
		sign.addressForm("Shritik", "Sharma", "testcom", "testadd", "testadd", "India", "M.P", "Gwalior", "3456","987654321");
